...
#ifndef TAOMEE_HEX_STR_H_
#define TAOMEE_HEX_STR_H_
...
/**
  ...
  */
static inline void
hex2char(uint8_t hex, void* deststring)
{
...
/**
  ...
  */
static inline void
hex2str(const void* srchex, size_t srclen, void* deststring)
{
...
/**
  ...
  */
static inline void
hex2str_s(const void* srchex, size_t srclen, void* deststring, const void* seperator)
{
	const uint8_t* hex = (const uint8_t*)srchex;
	char* dest = (char*)deststring;
...
#endif // end of TAOMEE_HEX_STR_H_
